...
SGS_APIFUNC void sgs_SerializeExt( SGS_CTX, sgs_Variable var, int mode, int ignoreSymbols);
...
#define sgs_Serialize( C, var ) sgs_SerializeExt( C, var, SGS_SERIALIZE_DEFAULT, 0)
