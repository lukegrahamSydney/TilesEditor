...
#define SGS_ST_OP_QMARK_CALL 245 /* ?.    */
...
typedef struct sgs_JoinedTokenList sgs_JoinedTokenList;
struct sgs_JoinedTokenList
{
	sgs_TokenList tokens;
	sgs_JoinedTokenList* next;
};
...
struct sgs_Context
{
	...
	//for joins
	sgs_MemBuf	  joinFiles;
	sgs_JoinedTokenList* jt_first;
	sgs_JoinedTokenList* jt_last;
	/* virtual machine */
